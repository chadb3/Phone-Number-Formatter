...
usa_area_codes="""CREATE TABLE "USA_AREA_CODES" (
	"AREA_CODE"	INTEGER NOT NULL DEFAULT 9999 UNIQUE,
	"STATE"	TEXT,
	PRIMARY KEY("AREA_CODE")
)"""

na_area_codes="""CREATE TABLE "NA_AREA_CODES" (
...
state_info="""CREATE TABLE "STATE_INFO" (
